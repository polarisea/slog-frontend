...
<template>
  <div
    class="fixed left-0 top-0 z-[100] flex h-[4rem] w-full items-center justify-between border-b-[1px] border-line-color bg-white px-[2rem] py-[8px]">
    ...
    <span
      ...
      <div
        class="searchbox absolute w-full min-h-[5rem] bg-gray-100 top-0 rounded-tl-[2rem] shadow-lg  rounded-tr-[2rem] z-0 pt-[3rem] px-[1rem]">
    ...
    <span class="relative flex items-center">
      ...
      <a href="https://code.dev:8000/google/login"
        ...
        @click="handleLogin" v-if="!userStore.isLogin">
        Đăng nhập
      </a>
